import { IState, IBrowser, IAction, IBrowserGroup, IProxy } from "tilted_aio_shared";
import { UPDATE_BROWSERS, SAVE_DATA, UPDATE_BROWSER_GROUPS, UPDATE_PROXIES } from "tilted_aio_shared";
